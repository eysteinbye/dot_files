" Vim color file - Eystein
" Generated by http://bytefluent.com/vivify 2015-10-20
set background=dark
if version > 580
	hi clear
	if exists("syntax_on")
...
hi Normal guifg=#00af5f guibg=#1e1e27 guisp=#1e1e27 gui=NONE ctermfg=35 ctermbg=235 cterm=NONE
...
hi Special guifg=#eeeeee guibg=NONE guisp=NONE gui=NONE ctermfg=255 ctermbg=NONE cterm=NONE
...
hi Function guifg=#d787ff guibg=NONE guisp=NONE gui=NONE ctermfg=177 ctermbg=NONE cterm=NONE
hi FoldColumn guifg=#8b8bcd guibg=#2e2e2e guisp=#2e2e2e gui=NONE ctermfg=104 ctermbg=236 cterm=NONE
hi PreProc guifg=#eeeeee guibg=NONE guisp=NONE gui=NONE ctermfg=255 ctermbg=NONE cterm=NONE
